...
class Robot_Control(Node):
    ...
    def command_wheels(self):
        if self.robot_motion == "stop":
            ...
            right_duty_cycle = (1150/20000) * 100 # changed from 1200 to 1300
            left_duty_cycle = (1650/20000) * 100
            ...
            self.pwm_front_left.start(duty_cycle)
            self.pwm_front_right.start((1392/20000) * 100)
            self.pwm_back_left.start(duty_cycle)
            self.pwm_back_right.start((1392/20000) * 100)
